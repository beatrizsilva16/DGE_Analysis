...
#addddd 
setwd("C:/Users/USUARIO/Desktop/Ude_analysis/Gene_expression")
...
DGE list EdgeR - North 20 ºC vs South 20 ºC
```{r}
...
DGE list EdgeR - North 25 ºC vs South 25 ºC
```{r}
...
DGE list EdgeR - North 30 ºC vs South 30 ºC
```{r}
...
DGE list EdgeR - North 20 ºC, 25ºC, 30ºC
```{r}
...
DGE list EdgeR - South 20 ºC, 25ºC, 30ºC
```{r}
...
DGE list Limma - North 20 ºC vs South 20 ºC
```{r}
...
DGE list Limma - North 25 ºC vs South 25 ºC
```{r}
...
DGE list Limma - North 30 ºC vs South 30 ºC
```{r}
...
DGE list Limma - North 20 ºC, 25 ºC, 30 ºC
```{r}
...
DGE list Limma - South 20 ºC, 25 ºC, 30 ºC
```{r}
...
DGE list DESeq2 - North 20 ºC vs South 20 ºC
```{r}
...
DGE list DESeq2 - North 25 ºC vs South 25 ºC
```{r}
...
DGE list DESeq2 - North 30 ºC vs South 30 ºC
```{r}
...
DGE list DESeq2 - North 20 ºC, 25 ºC, 30 ºC
```{r}
...
DGE list DESeq2 - South 20 ºC, 25 ºC, 30 ºC
```{r}
...
DGE list DESeq2 - North vs South
```{r}
...
Overlap between the three methods - North 20 ºC vs South 20 ºC
```{r}
...
Overlap between the three methods - North 25 ºC vs South 25 ºC
```{r}
...
Overlap between the three methods - North 30 ºC vs South 30 ºC
...
Overlap between the three methods - North 20 ºC, 25 ºC, 30ºC
...
Overlap between the three methods - South 20 ºC, 25 ºC, 30ºC
